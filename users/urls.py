...
from users.views import logout_view, LoginView, SignUpView, UserProfileView, UpdateProfileView, UpdatePasswordView, LikeView
...
urlpatterns = [
  ...
  path("likelist/", LikeView.as_view(), name="like-list")
]
